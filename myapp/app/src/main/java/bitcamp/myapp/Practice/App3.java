...
public class App3 {
  ...
  static final String[] ASSINGMENTS = {
      ANSI_BOLD_RED + "[과제]" + ANSI_CLEAR,
      "1. 등록",
      "2. 조회",
      "3. 변경",
      "4. 삭제",
      ANSI_RED + "0. 이전" + ANSI_CLEAR
  };
...
/*    System.out.println("\u001B[31m[과제관리 시스템]\033[0m");
 ...
 /*   String ANSI_BOLD_RED = "\033[1;31m";
  ...
  static void printAssingmentmenus() {
    for (String assignment : ASSINGMENTS) {
  ...
  static void onAssingments(Scanner keyIn) {
    printAssingmentmenus();
    loop:
    while (true) {
  ...
  static void printBoardMenus() {
    System.out.println(ANSI_BOLD_RED + "게시글" + ANSI_CLEAR);
    System.out.println("1. 등록");
    System.out.println("2. 조회");
    System.out.println("3. 변경");
    System.out.println("4. 삭제");
    System.out.println(ANSI_RED + "0. 이전" + ANSI_CLEAR);
  }
}
   /* String input = keyIn.nextLine();
