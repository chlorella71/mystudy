...
public abstract class AbstractDao<T> {
  ...
  void loadData(String filepath/*, Class<E> clazz*/) {
...
//    }
    ...
    try (
      ...
      Class<?> dataType = (Class) ((ParameterizedType) this.getClass() // 이 메섣를 호출한 클래스의 정보를 알아낸다.
  ...
  void saveData(String filepath) /*throws Exception*/ {
